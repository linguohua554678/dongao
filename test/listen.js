...
define(function (require, exports, module) {
    ...
    function bindSecond(id) {
        $.ajax({
            url: "http://esp-resource-service.beta.101.com/v1.0/groupitem?id=" + id,
            type: "GET",
            dataType: "jsonp", //指定服务器返回的数据类型
            success: function (lst) {
                $("#second").html("");
        ...
        onFun: function () {
            ...
            $('.lesson_evaluate_btn').on('click', function () {
                ...
                if (val.length == 0) {
                    ...
                    setTimeout(function () {
                        $('.pop_lesson_cont_alt').eq(0).hide();
                    }, 3000);
                } else if (val.length > 0 && val.length <= 140) {
